...
select nome, sobrenome from funcionarios order by salario desc limit 5;
 ...
 select * from funcionarios where (sobrenome='Benn' or sobrenome='Ramet') and salario <5000;
  ...
  select count(*) as totatl from funcionarios where salario between 1212 and 5000;
  
  select count(*) as totatl from funcionarios where salario between 5001 and 10000;
  
  select count(*) as totatl from funcionarios where salario between 10001 and 15000;